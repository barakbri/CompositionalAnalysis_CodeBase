...
plot(jitter(Y_tilde_j,0),jitter(Y_tilde_r,6),pch=1,col = 'black',xlim = c(0,lambda_rar),ylim = c(0,lambda_rar),main = 'B',xlab = "Counts in taxon j, after subsampling",ylab = "Counts in reference, after subsampling" ,cex = cex_param)
...
plot(jitter(Y_tilde_j_filtered,0),jitter(Y_tilde_r_filtered,6),pch=1,col = 'black',xlim = c(0,lambda_rar_filtered),ylim = c(0,lambda_rar_filtered),main = 'C',xlab = "Counts in taxon j, after subsampling",ylab = "Counts in reference, after subsampling" ,cex = cex_param)
