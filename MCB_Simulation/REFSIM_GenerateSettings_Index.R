...
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, GlobalNull, 60:60', m_diff_abundant = 0,global_NULL = T, effect_relative_to_total_sample = 0.00, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS)
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 10, 60:60, effect = 0.5', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 0.5, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 100, 60:60, effect = 0.5', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 0.5, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 10, 60:60, effect = 1.0', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 1.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 100, 60:60, effect = 1.0', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 1.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 10, 60:60, effect = 1.5', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 1.5, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 100, 60:60, effect = 1.5', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 1.5, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS)
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 10, 60:60, effect = 2.0', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 100, 60:60, effect = 2.0', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 10, 60:60, effect = 2.5', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.5, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 100, 60:60, effect = 2.5', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.5, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
...
# 26,27
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 10, 60:60, effect = 3.0', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 3.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'qPCR, m1 = 100, 60:60, effect = 3.0', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 3.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS)