...
# 28 - 41 - scenarios added nov 2019 - for confounding affect between sequencing depth and group labeling
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, GlobalNull, 60:60, group 1 oversampled', m_diff_abundant = 0,global_NULL = T, effect_relative_to_total_sample = 0.00, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3)
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, GlobalNull, 60:60, group 1 undersampled', m_diff_abundant = 0,global_NULL = T, effect_relative_to_total_sample = 0.00, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3)

REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 1.0, group 1 oversampled', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 1.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 1.0, group 1 undersampled', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 1.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3) 

REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 1.0, group 1 oversampled', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 1.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 1.0, group 1 undersampled', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 1.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3) 

REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 2.0, group 1 oversampled', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 2.0, group 1 undersampled', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3) 

REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 2.0, group 1 oversampled', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 2.0, group 1 undersampled', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3) 

REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 3.0, group 1 oversampled', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 3.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 3.0, group 1 undersampled', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 3.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3) 

REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 3.0, group 1 oversampled', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 3.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 3)
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 3.0, group 1 undersampled', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 3.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,Reads_Multiplier_Group_1 = 1/3)

# 42 - 47
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 2.0, NB - 10%', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,NB_dispersion_extra_variance_as_part_mu = 0.1) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 2.0, NB - 10%', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,NB_dispersion_extra_variance_as_part_mu = 0.1)
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 2.0, NB - 20%', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,NB_dispersion_extra_variance_as_part_mu = 0.2) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 2.0, NB - 20%', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,NB_dispersion_extra_variance_as_part_mu = 0.2)
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 10, 60:60, effect = 2.0, NB - 30%', m_diff_abundant = 10,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,NB_dispersion_extra_variance_as_part_mu = 0.3) 
REFSIM_SETTINGS_LIST[[length(REFSIM_SETTINGS_LIST) + 1]] = REFSIM_generate_Gut_TYPE_Scenario(label = 'Gut, m1 = 100, 60:60, effect = 2.0, NB - 30%', m_diff_abundant = 100,global_NULL = F, effect_relative_to_total_sample = 2.0, n0 = n_flow,n1 = n_flow, poisson_mean_reads = FLOW_MEDIAN_READS,NB_dispersion_extra_variance_as_part_mu = 0.3) 