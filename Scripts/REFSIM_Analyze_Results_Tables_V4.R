#This script produces the graphs and tables shown in section 5, and appendix 2 (additional scenarios).
# Version 3 of this script also includes the ZINB-WAVE+DESEQ2 test variant
# Version 4 of this script also includes the ZINB-WAVE+DESEQ2 test variant
