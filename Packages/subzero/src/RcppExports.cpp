...
RcppExport SEXP _subzero_rcpp_TwoPartTest(SEXP XSEXP, SEXP YSEXP, SEXP BSEXP, SEXP DoWaldSEXP, SEXP ReportPermSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type X(XSEXP);
...
RcppExport SEXP _subzero_rcpp_TwoPartTest_Given_Permutations(SEXP XSEXP, SEXP YSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type X(XSEXP);
...
RcppExport SEXP _subzero_rcpp_Compute_Wilcoxon_Signed_Rank_Stat(SEXP RankedDifferencesSEXP, SEXP SecondGroupBiggerSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_subzero_rcpp_TwoPartTest", (DL_FUNC) &_subzero_rcpp_TwoPartTest, 5},
    {"_subzero_rcpp_TwoPartTest_Given_Permutations", (DL_FUNC) &_subzero_rcpp_TwoPartTest_Given_Permutations, 2},
    {"_subzero_rcpp_Compute_Wilcoxon_Signed_Rank_Stat", (DL_FUNC) &_subzero_rcpp_Compute_Wilcoxon_Signed_Rank_Stat, 2},
    {NULL, NULL, 0}
};
